...
public class BlockEntityInit {
    ...
    public static BlockEntityType<WoodenBarrelEntity> WOODEN_BARREL_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(AlkimiCraft.MOD_ID, "wooden_barrel"), FabricBlockEntityTypeBuilder.create(WoodenBarrelEntity::new, BlockInit.WOODEN_BARREL).build());
