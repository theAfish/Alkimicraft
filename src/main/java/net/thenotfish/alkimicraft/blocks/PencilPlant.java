...
public class PencilPlant extends ConnectingBlock {
    public PencilPlant(Settings settings) {
    ...
    public void onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (player.getStackInHand(Hand.MAIN_HAND).isEmpty()) {
            player.addStatusEffect(new StatusEffectInstance(StatusEffects.POISON, 200, 0, false, true));
        }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        do {
            ...
            do {
                if (!var6.hasNext()) {
                    return blockState.isOf(this) || blockState.isOf(BlockInit.LOAMY_SAND);
                }
...
//            }
        ...
        } while(!blockState3.isOf(this) && !blockState3.isOf(BlockInit.LOAMY_SAND));
